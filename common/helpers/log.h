...
void info_log(const char *str, ...) __THROWNL __nonnull((1));
void debug_log(const char *str, ...) __THROWNL __nonnull((1));
void error_log(const char *str, ...) __THROWNL __nonnull((1));
